...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         their colleagues, and Parker Jordan.
...
def run_test_problem1a():
    ...
    # Test 3:
    expected = 0.0633210628   # This is APPROXIMATELY the correct answer.
    ...
    # Test 4:
    expected = 1.135085925   # This is APPROXIMATELY the correct answer.
...
def problem1a(m, n):
    ...
    for k in range((n ** 2) - (m ** 2) + 1):
        total= total + math.sin((abs(m) ** 2)+k)
    return total
